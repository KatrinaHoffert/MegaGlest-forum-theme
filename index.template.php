...
<div id="wrapper">' : '', '
	...
	echo '
		...
		<div id="upper_section" class="middletext"', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
			<div id="upper_section_a">';
	
	if ($context['user']['is_logged'])
	{
		echo '<span class="greeting">', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></span>';
	}
	echo '
			</div>
			<div class="user">';
	...
	if ($context['user']['is_logged'])
	{
		...
		echo '
				<ul class="reset" style="margin-top: 5px;">
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li class="copyright">Glest Theme by Omega</li>
